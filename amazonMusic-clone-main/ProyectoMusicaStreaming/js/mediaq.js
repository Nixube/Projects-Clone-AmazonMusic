//evento para cuando la ventana cambie de tamaño
window.addEventListener("resize", function () {
  ...
  //si la pantalla tiene mas de 1000 pixeles
  if (anchoPantalla > 1000) {
    //se mostrarian completamente todos los elementos
...
>
  ...
  >
    ...
    buscarOpcion.innerHTML = `<input id="searchInput" type="text" placeholder="Buscar" /><button id="searchButton" type="submit" onclick="buscar()">Buscar</button>`;
  }
  //si la pantalla tiene menos de 1000 pixeles
  if (anchoPantalla < 1000) {
    //quito el texto de las imagenes
    inicioOpcion.innerHTML = `<svg
    xmlns="http://www.w3.org/2000/svg"
    xmlns:xlink="http://www.w3.org/1999/xlink"
    width="24"
...
>
  ...
  >
    ...
    //quito el boton del apartado de buscar
    buscarOpcion.innerHTML = ` <input id="searchInput" type="text" placeholder="Buscar" />`;
    loginOpcion.innerHTML = `<a href="login.html">Cerrar Sesión</a>`;
  }
  //si la pantalla tiene 500 o menos pixeles
  if (anchoPantalla <= 500) {
    //quito las busquedas y el login
